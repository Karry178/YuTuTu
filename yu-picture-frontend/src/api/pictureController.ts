...
/** deletePic POST /api/picture/delete */
export async function deletePicUsingPost(
...
/** listPictureVOByPageWithCaffeineCache POST /api/picture/list/page/vo/cache/caffeine */
...
/** listPictureVOByPageWithRedisCache POST /api/picture/list/page/vo/cache/redis */
export async function listPictureVoByPageWithRedisCacheUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
